...
* **Heuristics MAY detect only structural defects:**
  - duplicate IDs
  - unused fields
  - malformed plan objects
  - missing required attributes
  - These structural checks are pre-validation filters, not semantic validation
...
* **Default Convergence Criteria:**
  ...
  - coherence >= 0.90
  - consistency >= 0.90
  - no CRITICAL issues from validator
  - no HIGH tool/hallucination issues
  - no missing required steps
  - plan produces valid final output
